Class.delete_all
Class.create("dept" => "HEMA", "class_no" => "914", "class_name" => "Biomedical Marketing")
Class.create("dept" => "MGMT", "class_no" => "441", "class_name" => "Intellectual Capital Management")
Class.create("dept" => "OPNS", "class_no" => "923", "class_name" => "Enterprise Risk Management")
Class.create("dept" => "KIEI", "class_no" => "925", "class_name" => "Startup Programming and Management")
Class.create("dept" => "FINC", "class_no" => "454", "class_name" => "Real Estate Finance and Investments")
Class.create("dept" => "HEMA", "class_no" => "453", "class_name" => "Managerial Challenges in the Pharmaceutical, Biotech, and Medical Device Industries")
Class.create("dept" => "MECN", "class_no" => "430", "class_name" => "Microeconomic Analysis")
Class.create("dept" => "INTL", "class_no" => "473", "class_name" => "Global Initiatives in Management")
Class.create("dept" => "ACCT", "class_no" => "430", "class_name" => "Accounting for Decision Making")
Class.create("dept" => "DECS", "class_no" => "431", "class_name" => "Business Analytics II")
Class.create("dept" => "FINC", "class_no" => "440", "class_name" => "Finance I/II")
Class.create("dept" => "MGMT", "class_no" => "431", "class_name" => "Business Strategy")
Class.create("dept" => "KIEI", "class_no" => "462", "class_name" => "New Venture Discovery")
Class.create("dept" => "ACCT", "class_no" => "434", "class_name" => "Turbo Accounting")
Class.create("dept" => "FINC", "class_no" => "940-A", "class_name" => "Financial Modeling for Leveraged Buyout Transactions")
Class.create("dept" => "ACCT", "class_no" => "452", "class_name" => "Financial Reporting and Analysis II")
